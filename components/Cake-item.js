...
const Cake = ({ cakes }) => {
    ...
    return (
        <div>
                {cakes.map(cake => (
                    <div key={cake._id} onClick={() => router.push(`/cakes/${cake._id}`)} className="container flex justify-between rounded-md transition duration-500 ease-in-out shadow-md p-3 my-5 bg-white sm:max-w-sm cursor-pointer hover:shadow-xl">
